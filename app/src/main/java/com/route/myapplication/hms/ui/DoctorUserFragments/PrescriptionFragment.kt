...
//import Android.widgit.ArrayAdapter

class PrescriptionFragment : Fragment() {
    val medicineTypeArray = arrayOf("Liquid","Capsules","Drops","Injections","Rectal Suppositories")
...
//            RepetitionSpinner.adapter=RepetitionSpinnerarrayAdapter
        ...
        ConfirmaddPrescribtionBtn.setOnClickListener {
            ...
            addView(MedicineNameEditText.text.toString(),MedicineSterngthEditText.text.toString(),InstructionsEditText.text.toString(),MedicinetypeEditText.selectedItemId.toInt(),
                DurationEditText.text.toString(),DurationSpinner.selectedItemId.toInt(),RepetitionEditText.text.toString(),RepetitionSpinner.selectedItemId.toInt(),DoseEditText.text.toString())
        }

    }

    private fun addView(medicineName:String,medicineSterngth:String,instructions:String,medicinetype:Int,duration:String,durationSpinner:Int,repetition:String,repetitionSpinner:Int,dose:String){
        val AddPrescriptionView :  View = layoutInflater.inflate(R.layout.add_new_prescription,null,false)

        val AddedmedicineNameEditText : EditText =AddPrescriptionView.findViewById(R.id.addedmedicineNameEditText)
        AddedmedicineNameEditText.setText(medicineName)
        AddedmedicineNameEditText.isEnabled=false

        val AddedmedicineSterngthEditText : EditText =AddPrescriptionView.findViewById(R.id.addedmedicineSterngthEditText)
        AddedmedicineSterngthEditText.setText(medicineSterngth)
        AddedmedicineSterngthEditText.isEnabled=false

        val AddedinstructionsEditText : EditText =AddPrescriptionView.findViewById(R.id.addedinstructionsEditText)
        AddedinstructionsEditText.setText(instructions)
        AddedinstructionsEditText.isEnabled=false

        val AddedmedicinetypeEditText : Spinner =AddPrescriptionView.findViewById(R.id.addedmedicinetypeEditText)
        AddedmedicinetypeEditText.setSelection(medicinetype)
        AddedmedicinetypeEditText.isEnabled=false

        val AddeddurationEditText : EditText =AddPrescriptionView.findViewById(R.id.addeddurationEditText)
        AddeddurationEditText.setText(duration)
        AddeddurationEditText.isEnabled=false

        val AddeddurationSpinner : Spinner =AddPrescriptionView.findViewById(R.id.addeddurationSpinner)
        AddeddurationSpinner.setSelection(durationSpinner)
        AddeddurationSpinner.isEnabled=false

        val AddedrepetitionEditText : EditText =AddPrescriptionView.findViewById(R.id.addedrepetitionEditText)
        AddedrepetitionEditText.setText(repetition)
        AddedrepetitionEditText.isEnabled=false

        val AddedrepetitionSpinner : Spinner =AddPrescriptionView.findViewById(R.id.addedrepetitionSpinner)
        ...
        val AddedEditPrescribtionBtn : Button =AddPrescriptionView.findViewById(R.id.addedEditPrescribtionBtn)
        AddedEditPrescribtionBtn.setOnClickListener {
            EditView(AddPrescriptionView)
        }

        val AddedSavePrescribtionBtn : Button =AddPrescriptionView.findViewById(R.id.addedSavePrescribtionBtn)
        AddedSavePrescribtionBtn.setOnClickListener {
            SaveView(AddPrescriptionView)
        }

        val addedRemovePrescribtionBtn : Button =AddPrescriptionView.findViewById(R.id.addedRemovePrescribtionBtn)

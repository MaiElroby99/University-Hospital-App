...
class OutPatientAdapter(var items :List<OutPatientDetails>) : RecyclerView.Adapter<OutPatientAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return OutPatientAdapter.ViewHolder(view)
    }
    ...
    interface OnImageClickListener{
        fun onImageClick(pos:Int,item:OutPatientDetails)
    }
